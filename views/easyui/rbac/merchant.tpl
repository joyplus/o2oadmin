...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'Name',title:'商户名字',width:100,sortable:true,editor:'text'},
            ...
            {field:'MerchantType',title:'商户类型',width:50,align:'center',
        ...
        onAfterEdit:function(index, data, changes){
            ...
            changes.Id = data.Id;
            vac.ajax(URL+'/updateMerchant', changes, 'POST', function(r){
                if(!r.status){
                    vac.alert(r.info);
                }else{
