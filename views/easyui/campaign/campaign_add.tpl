...
<div class="form-group">
			...
			<div class="form-group audience-group">
                ...
                <div class="col-sm-8">
					{{range index .lovmaps "accurate_type"}}
						{{if eq .DispOrder 0}}
			...
			<div class="form-group audience-group">
                ...
                <div class="col-sm-8">
                    <label class="radio-inline ng-scope" ng-repeat="item in audienceItems.district">
                    ...
                    </label><label class="radio-inline ng-scope" ng-repeat="item in audienceItems.district">
...
<div class="col-sm-8" id="delivery-time">
   ...
   -->
    ...
    <div class="radio">
        ...
        <div class="embed future_date" for-radio="schedule_type" data-value="4" style="display: block;">

            开始  :  <input type="text" id="start_date" class="form-control form-control-inline" name="start_date" value="2015-09-20">
            结束  :  <input type="text" id="end_date" class="form-control form-control-inline" name="end_date" value="2015-10-20">
            ...
            <div id="calendarContainer" style="margin-top:10px;">
                ...
                <div style="display:none;" class="readableWeekModel">
                    <li>星期<span class="readableWeekday">三</span>,<time class="readableWeektime1">2:00</time>~<time class="readableWeektime2">2:30</time><i class="del" data-time="39" data-week="6">×</i></li>
                </div>
